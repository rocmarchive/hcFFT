...
namespace CopyGenerator
{
        ...
        void GenerateKernel(const hcfftPlanHandle plHandle, std::string &str, vector< size_t > gWorkSize, vector< size_t > lWorkSize)
	{
		...
		if(inIlvd)
		{
			str += "inOffset = iOffset + "; str += inF; str += ";\n\t";
		}
		else
		{
			str += "inReOffset = iOffset + "; str += inF; str += ";\n\t";
			str += "inImOffset = iOffset + "; str += inF; str += ";\n\t";
		}

		// outputs
		if(outIlvd)
		{
			str += "outOffset = oOffset + "; str += outF; str += ";\n";
			if(h2c)
			{
				str += "\t";
				str += "outOffset2 = oOffset + "; str += outF2; str += ";\n";
			}
		}
		else
		{
			str += "outReOffset = oOffset + "; str += outF; str += ";\n\t";
			str += "outImOffset = oOffset + "; str += outF; str += ";\n";
			if(h2c)
			{
				str += "\t";
				str += "outReOffset2 = oOffset + "; str += outF2; str += ";\n\t";
				str += "outImOffset2 = oOffset + "; str += outF2; str += ";\n";
			}
		}
