          ...
          if(fwd) {
            if(cReg) {
              bflyStr +=
                ...
                "TR1 = ((R0[0]).x - ";
                bflyStr += cReg ? RegBaseType<PR>(2) : RegBaseType<PR>(1);
...
bflyStr += "(C5QE)*TI9);\n\t";
      ...
      case 11: {
          static const char* radix11str = " \
						...
						p1 = R1[0].x + R10[0].x; \n\
						p2 = (R5[0].x - R6[0].x)*dir; \n\
						p3 = R5[0].x + R6[0].x; \n\
						p4 = (R2[0].x - R9[0].x)*dir; \n\
						p5 = R2[0].x + R9[0].x; \n\
						p6 = (R3[0].x - R8[0].x)*dir; \n\
						p7 = R3[0].x + R8[0].x; \n\
						p8 = R4[0].x + R7[0].x; \n\
						p9 = (R4[0].x - R7[0].x)*dir; \n\
						\n\
						...
						p10 = (R10[0].y - R1[0].y)*dir; \n\
						p11 = R1[0].y + R10[0].y; \n\
						p12 = (R9[0].y - R2[0].y)*dir; \n\
						p13 = R2[0].y + R9[0].y; \n\
						p14 = (R8[0].y - R3[0].y)*dir; \n\
						p15 = R3[0].y + R8[0].y; \n\
						p16 = (R7[0].y - R4[0].y)*dir; \n\
						p17 = R4[0].y + R7[0].y; \n\
						p18 = (R6[0].y - R5[0].y)*dir; \n\
						p19 = R5[0].y + R6[0].y; \n\
						\n\
						...
						z9 = R0[0].y - w19 * b11_1; \n\
						\n\
						R0[0].x = R0[0].x + p1 + p3 + p5 + p7 + p8; \n\
						R0[0].y = R0[0].y + p11 + p13 + p15 + p17 + p19; \n\
						R1[0].x = z1 + w14* b11_0; \n\
						R1[0].y = z7 + w1* b11_0; \n\
						R2[0].x = z2 - w12* b11_0; \n\
						R2[0].y = z8 - w2* b11_0; \n\
      ...
      case 13: {
          static const char* radix13str = " \
						...
						m13 = m6 + m11;\n\
						\n\
						m14 =  R1[0].y - r5 * b13_17;\n\
						m15 = -R12[0].y + r6 * b13_17;\n\
						m16 =  r2      - m4 * b13_17;\n\
						\n\
						m17 = m14 + m15;\n\
						m18 = m14 - m15;\n\
						...
						R0[0].x  = R0[0].x + s8;\n\
						R0[0].y  = R0[0].y + m13;\n\
						R1[0].x  =  e6 +  f2 * dir * b13_9 ;\n\
						R1[0].y  = e12 - f12 * dir * b13_9 ;\n\
						R2[0].x  =  f9 - f10 * dir * b13_11;\n\
						R2[0].y  = f19 + f16 * dir * b13_11;\n\
						R3[0].x  =  f6 -  f5 * dir * b13_13;\n\
						R3[0].y  = f20 + f23 * dir * b13_13;\n\
						R4[0].x  =  f7 -  f4 * dir * b13_13;\n\
						R4[0].y  = f21 + f22 * dir * b13_13;\n\
						R5[0].x  =  e7 -  f1 * dir * b13_9 ;\n\
						R5[0].y  = e13 + f15 * dir * b13_9 ;\n\
						R6[0].x  =  f8 - f11 * dir * b13_11;\n\
						R6[0].y  = f18 + f17 * dir * b13_11;\n\
						R7[0].x  =  f9 + f10 * dir * b13_11;\n\
						R7[0].y  = f19 - f16 * dir * b13_11;\n\
						R8[0].x  =  e7 +  f1 * dir * b13_9 ;\n\
						R8[0].y  = e13 - f15 * dir * b13_9 ;\n\
						R9[0].x  =  f6 +  f5 * dir * b13_13;\n\
						R9[0].y  = f20 - f23 * dir * b13_13;\n\
						R10[0].x =  f7 +  f4 * dir * b13_13;\n\
						R10[0].y = f21 - f22 * dir * b13_13;\n\
						R11[0].x =  f8 + f11 * dir * b13_11;\n\
						R11[0].y = f18 - f17 * dir * b13_11;\n\
